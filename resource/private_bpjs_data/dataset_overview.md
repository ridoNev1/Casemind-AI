...
| Kolom      | Contoh Nilai | Interpretasi                                                                                                    |
| :--------- | :----------- | :-------------------------------------------------------------------------------------------------------------- |
| **PSTV01** | `15`         | ID kunjungan/pelayanan ke-15                                                                                    |
| **PSTV02** | `15`         | ID peserta ke-15 (unik untuk setiap peserta)                                                                    |
| **PSTV03** | `1944-03-01` | Tanggal lahir atau tanggal pelayanan pertama (mungkin tanggal lahir peserta, karena formatnya lama dan konstan) |
| **PSTV04** | `1`          | Jenis pelayanan (misal 1 = rawat jalan)                                                                         |
| **PSTV05** | `2`          | Kode Faskes (misal 2 = rumah sakit rujukan)                                                                     |
| **PSTV06** | `9`          | Diagnosa utama (kode ICD-10 disandikan sebagai angka)                                                           |
| **PSTV07** | `3`          | Diagnosa tambahan (komorbiditas, misal hipertensi/DM)                                                           |
| **PSTV08** | `2`          | Kode tindakan medis (misalnya konsultasi atau pemeriksaan ringan)                                               |
| **PSTV09** | `72`         | Kode obat/resep                                                                                                 |
| **PSTV10** | `7206`       | Bisa jadi kode pelayanan detail (misalnya nomor batch, atau ID sublayanan)                                      |
| **PSTV11** | `3`          | Status rujukan (misal 3 = selesai / kontrol kembali)                                                            |
| **PSTV12** | `1`          | Status kepesertaan (misal 1 = aktif)                                                                            |
| **PSTV13** | `72`         | Kode jenis kelamin (ini tampaknya salah posisi — kemungkinan duplikasi dari kolom sebelumnya)                   |
| **PSTV14** | `7206`       | Umur peserta (tapi nilainya terlalu besar, jadi mungkin kode wilayah)                                           |
| **PSTV15** | `40.024914`  | Biaya pelayanan (dalam ribuan atau jutaan rupiah tergantung skala dataset)                                      |
| **PSTV16** | `2016`       | Tahun pelayanan                                                                                                 |
| **PSTV17** | `99`         | Status validasi klaim (99 = belum diverifikasi atau error data)                                                 |
| **PSTV18** | `NaN`        | Nilai klaim disetujui — kosong artinya belum diproses atau belum dibayar                                        |
